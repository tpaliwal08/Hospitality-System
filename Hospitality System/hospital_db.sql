...
--
-- Host: localhost
-- Generation Time: May 17, 2013 at 04:30 AM
...
CREATE TABLE IF NOT EXISTS `doctors` (
  ...
  `Available_opd` varchar(20) NOT NULL,
  `created_date` date NOT NULL,
  `modified_date` date NOT NULL,
  `status` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `doctors` (`id`, `firstname`, `lastname`, `email`, `mobile`, `address`, `specialization`, `Available_opd`, `created_date`, `modified_date`, `status`) VALUES
...
(8, 'Dr. Jagruti', 'Gupta', 'jagruti@gmail.com', '9858585855', 'naulkha ,indore', 10, '', '0000-00-00', '2013-05-13', 1),
(10, 'anil', 'karadwal', 'aani.karadwal@gmail.com', '2147483647', 'indore', 11, '', '0000-00-00', '0000-00-00', 1),
(11, 'arun', 'shah', 'arun.kumavatt@gmail.com', '9685354979', 'naulkha ,indore', 13, '', '2013-05-03', '2013-05-03', 0),
(12, 'arun', 'kumavat', 'aanii.karadwal@gmail.com', '9893898999', 'indore', 15, '', '2013-05-03', '2013-05-03', 0),
(13, 'Chetan', 'Yadav', 'kdsf@jfksjf.com', '9049049304', 'dfls', 10, '', '2013-05-13', '2013-05-13', 0),
(14, 'rahul', 'rahul', 'ra@fjfj.com', '9875865898', 'bhopal', 16, '', '2013-05-16', '2013-05-16', 1),
(15, 'fsdf', 'fsf', 'dfs', '9875865898', 'indore', 16, '', '2013-05-16', '2013-05-16', 1),
(16, 'fsf', 'dsfds', 'dffs@dfs.com', '9875865898', 'indore', 13, '', '2013-05-16', '2013-05-16', 1),
(17, 'Ramesh', 'sharma', 'ra@fjfj.com', '9875865898', 'indore', 11, 'yes', '2013-05-17', '2013-05-17', 1);
...
CREATE TABLE IF NOT EXISTS `opd_doctor` (
  `doctor_id` int(11) NOT NULL,
  `comming_time` varchar(30) NOT NULL,
...
INSERT INTO `opd_doctor` (`doctor_id`, `comming_time`, `leaving_time`) VALUES
(0, '9 am', '12 pm'),
(0, '9 am', '12 pm'),
(17, '9 am', '12 pm');
...
CREATE TABLE IF NOT EXISTS `opd_patients` (
  ...
  `doctor_id` int(11) NOT NULL,
  `diseas` varchar(30) NOT NULL,
  `priscription` text NOT NULL,
  `pathologytest` int(11) NOT NULL,
  PRIMARY KEY (`opd_id`)
...
INSERT INTO `pathology_test` (`test_id`, `test_name`, `status`) VALUES
(1, 'Blood', 1),
(2, 'Urein', 1),
(3, 'X-Ray', 1);
...
(46, 'check0000', 'fjsk', 'jdjfs', 23, 'fkjsdkj', '2147483647', 'dfsd', 'yes', '2013-05-02', '2013-05-02', 0),
(47, 'check99999', 'fsdfsf', 'fsfsf', 24, 'fdsff', '2147483647', 'fsdfdss', 'yes', '2013-05-02', '2013-05-02', 0),
(48, 'check7777', 'abc', 'vwx', 23, 'ddd', '2147483647', 'fdffs vdf', 'yes', '2013-05-02', '2013-05-02', 0),
(49, 'check88888', 'dfsdf', 'dfdfss', 24, 'dfsfs', '2147483647', 'fdssfs', 'yes', '2013-05-02', '2013-05-02', 0),
(50, 'check123', 'fsfdsf', 'fdsfs', 24, 'fsfsd', '2147483647', 'dfdsfs', 'yes', '2013-05-02', '2013-05-02', 0),
...
(70, 'fsdf', 'dfsf', 'dfds', 23, 'xyz@gmail.com', '2147483647', 'indore', 'yes', '2013-05-03', '2013-05-03', 0),
...
(77, 'raju', 'yadav', 'ramu', 23, 'ddd@gmail.com', '9093039093', 'fdffs vdf', 'yes', '2013-05-02', '2013-05-02', 0),
...
(80, 'asdfg', 'yadav', 'hfjdshfj', 23, 'fkdskfs@gmail.com', '9856586598', 'dfsdfsf', 'yes', '2013-05-13', '2013-05-13', 0),
(81, 'hello', 'dfjkj', 'jfkdfj', 24, 'jfkdsf@jdfkdsjf.com', '9856586598', 'indore', 'no', '2013-05-13', '2013-05-13', 1),
(82, 'Ajay', 'Sharma', 'Harish', 25, 'chetanyadav7@gmail.com', '9878909878', 'Indore', 'yes', '2013-05-16', '2013-05-16', 0),
(83, 'Ajay', 'Sharma', 'Harish', 25, 'chetanyadav7@gmail.com', '9878909878', 'Indore', 'yes', '2013-05-16', '2013-05-16', 0);
...
(80, '0000-00-00', '2', 102, 2, 500, '0000-00-00'),
(82, '0000-00-00', '2', 302, 1, 1000, '0000-00-00'),
(83, '0000-00-00', '2', 303, 1, 200, '0000-00-00');
...
(80, 'asdfg', 'yadav', 'hfjdshfj', '9856586598', 'dfsdfsf', 'yes', 1000, 2000, 1000, 2500, 1500, '2013-05-13', '2013-05-13'),
(81, 'hello', 'dfjkj', 'jfkdfj', '9856586598', 'indore', 'no', 0, 2000, 2000, 2000, 2000, '2013-05-13', '2013-05-13'),
(82, 'Ajay', 'Sharma', 'Harish', '9878909878', 'Indore', 'yes', 3000, 1000, 3300, 0, 7300, '2013-05-16', '2013-05-16'),
(83, 'Ajay', 'Sharma', 'Harish', '9878909878', 'Indore', 'yes', 1000, 1000, 1000, -4000, 7000, '2013-05-16', '2013-05-16');
...
(6, 'Harish', 'Sharma', 'har@gmail.com', '9568568985', 5, '0000-00-00', '2013-05-13', 1),
(7, 'Janvi', 'Tripathi', 'janvi@gmail.com', '9658658987', 6, '0000-00-00', '2013-05-13', 1),
...
(12, 'dinesh', 'dfkfj', 'ds@gmail.com', '7856898589', 6, '2013-05-03', '2013-05-13', 1),
