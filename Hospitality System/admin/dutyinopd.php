...
<h2>If you want to move this Doctor to Opd than first fill the following fields.</h2>
<table border=1>
	  <tr>
	    <td align=center>Edit Doctors</td>
	  </tr>
	  <tr>
	    <td>
	      <table>
	...
	{
	$sql2="INSERT INTO opd_doctor(doctor_id,comming_time,leaving_time,status)VALUES(".$id.",'".$_POST['ctime']."','".$_POST['ltime']."','1')";
		  mysql_query($sql2);
