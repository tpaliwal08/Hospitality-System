...
INNER JOIN pathology_test
ON opd_patients.pathologytest = pathology_test.test_id WHERE patients.status='1'";
           $q3=mysql_query($q2) or die(mysql_error());
		 ...
		 $total=$_POST['docfee']+$_POST['medfee']+$_POST['pathfee']-$_POST['advance'];
  $query="INSERT INTO patient_payment
  (patient_id,p_firstname,p_lastname,pfather_name,mobile,
address,doctor_fee,medical_fee,total_amount,
advance_amount,created_date,modified_date)
  VALUES
  (".$pid.",
  '".$pfname."',
  '".$plname."',
 ...
 echo $pid;
// exit();
 $q2="UPDATE opd_patients SET pathology_fee='".$_POST['pathfee']."' WHERE patient_id='$pid'";
...
<tr>
<td><label class="black">Other Fee</label>
</td>
<td><input type="text" name="medfee" id="medfee" /></td>
</tr>
