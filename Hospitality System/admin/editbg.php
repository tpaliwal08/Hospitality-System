...
<h2>Edit Blood Group Deatails</h2>
	<form method="post" action="updatebg.php" name="form1" onsubmit="return ValidateForm()">
...
<table>
		    ...
		    <tr>       
	          <td>Blood Group</td>
	          <td>
	            <input type="text" name="bgname" id="bgname"
	        size="20" value="<?php echo $row['group_name']; ?>">
	          </td>
	        </tr>
	        <tr>
	          <td>Quantity</td>
	          <td>
	            <input type="text" name="sqty" size="20" id="sqty"
