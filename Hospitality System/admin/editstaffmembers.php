...
function ValidateForm(){
	...
	<form method="post" action="updatestaff.php" name="form1" onsubmit="return ValidateForm()">
          ...
          <table>
			...
			<tr>       
	          <td>Email</td>
	          <td>
	            <input type="text" name="smail" id="smail"
			...
			<tr>       
	          <td>Mobile</td>
	          <td>	
	            <input type="text" name="smob" id="smob"
